...
sys.path.append('../Week-3-SEO-Website')
...
class UsersTests(unittest.TestCase):
    ...
    def test_invalid_username_registration(self):
        ...
        response2 = self.register('iiiiiiiiiiiiiiiiiiiii', 'tst@example.com', 'FlaskisCool')
    ...
    def test_invalid_email_registration(self):
        ...
        response2 = self.register('t2', 'test@.com', 'Flasksucks')
